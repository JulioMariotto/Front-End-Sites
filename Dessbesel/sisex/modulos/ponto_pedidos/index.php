...
<body>
    ...
    <header>
        <a class="btn-nova-promocao" onclick="fadeInAdicionarPromocao()">
            <i class="uk-icon-plus"></i> Novo Pedido
        </a>
    ...
    <section>
        <div class="tabela">
            <div class="cabecalho_tabela" style="margin-top: 5%">
                ...
                <div class="col col-2">Data do Pedido</div>
                <div class="col col-3">Previsão da Chegada</div>
                <div class="col col-5">Descrição</div>
            ...
            <div id="listagem_promocoes">
                ...
                <a onclick="promocao.abreModal()">
                    <div class="bloco">
                        ...
                        <div class="col col-3">31/10/2017</div>
                        <div class="col col-5">Marmita 01 - 4 unidades, marmita 02...</div>
                </a>
                        <div class="col col-4"><select>
        ...
        <form class="conteudo" id="form-edita">
            ...
            <div class="tabela">
                ...
                <div id="listagem_promocoes" class="modal-lista">
                    ...
                    <div class="bloco">
                        <div class="col col-1">Marmita 03</div>
                        <div class="col col-2">05</div>
                        <div class="col col-3">R$69,90</div>
                    </div>
                    <div class="bloco">
                        <div class="col col-1">Marmita 06</div>
                        <div class="col col-2">03</div>
                        <div class="col col-3">R$39,90</div>
                    </div>
                </div>
            </div>

            <div id="botao_exclui">
                <a onclick="promocao.excluir()" class="btn-submit">Cancelar Pedido</a>
            </div>
